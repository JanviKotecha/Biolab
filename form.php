...
<br><br><br><br><br><br>
<center><h2 style="color: #0392ce;">COVID-19 REQUISITION FORM</h2></center><br><br>
<div class="content">
  <!--content inner-->
                ...
                <div class="multisteps-form__content">
                  <div class="form-row mt-4">
                    ...
                    <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                      <p>Last Name <sup style="color:#9194A0">*</sup> </p><input class="multisteps-form__input form-control" type="text" placeholder="" name="lnm" id="lnm" value="<?php echo  isset($_POST['submit']) ?  $lnm : '' ?>">
                      <small>Error Message</small>
                    </div>
                  </div>
                  <div class="form-row mt-4">
